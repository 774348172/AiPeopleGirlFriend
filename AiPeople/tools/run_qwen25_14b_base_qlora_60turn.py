...
PACKAGE_ROOT = ROOT / "training_packages" / "training_package_baiweixi_qwen25_14b"
ADAPTER_PATH = PACKAGE_ROOT / "outputs" / "baiweixi_qwen25_14b_unsloth"
FROZEN_INPUTS = (
    ROOT
    / "eval"
    / "world_mind_p0"
...
EXPECTED_ADAPTER_SHA256 = "f2c7e46004980045b8760ded951f14493c9ac1c09fad2e35a281032616b69417"
...
def _run_arm(
    ...
    *,
    ...
    return {
        ...
        "surface": "Transformers 5.5 + Unsloth bitsandbytes NF4, native Qwen2.5 ChatML",
        "turns": turns,
    }
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Qwen2.5-14B base versus Baiweixi QLoRA 60-turn test")
    ...
    qlora = _run_arm(
        ...
        tokenizer,
        key="qlora",
        label="Qwen2.5-14B NF4 + 白未晞 QLoRA",
        inputs=inputs,
        output_dir=output_dir,
        limit=args.limit,
    ...
    report = {
        "schema_version": 1,
        "scope": "qwen25_14b_base_vs_baiweixi_qlora_stateful_60turn",
