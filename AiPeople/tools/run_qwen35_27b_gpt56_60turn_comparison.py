...
LOCAL_LABEL = "Qwen3.5-27B Q4_K_M"
    ...
    async with httpx.AsyncClient(
        ...
        for turn in inputs:
            ...
            generated = await _generate_local(
                ...
                messages=messages,
                seed=seed,
                request_id=f"qwen35-gpt56-60:qwen35:turn-{ordinal:02d}",
            )
...
async def _run(args: argparse.Namespace) -> int:
    ...
    report = {
        "schema_version": 1,
        "scope": "stateful_qwen35_27b_q4_vs_gpt56sol_codex_internal_60turn",
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run Qwen3.5-27B Q4 vs internal GPT 60-turn test"
    )
