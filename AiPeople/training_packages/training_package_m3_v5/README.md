# Apple M3 训练包 v5 —— 秦未晞 (Qwen3-4B LoRA)
...
> **v5（2026-08-07）与 v4 的区别：新增 P1-P4 修复后生成的 48 条全绿验证样本（general 24 / safety 18 / casual 6——安全急救动作经 G8 硬门验证、general 逻辑题正常作答、无身份/属性朗读），主数据共 1164 条。存量 2500 仍不混入。**
