#!/usr/bin/env python3
"""合并 adapter + 转 GGUF（Q4_K_M）——白未晞。
训练完后跑这个脚本，产出可直接 ship 给玩家的 GGUF 文件。

用法: python scripts/export_gguf.py
前提: 已完成训练（outputs/baiweixi_4b/ 下有 adapter）
"""
import os
import subprocess

ADAPTER_DIR = "outputs/baiweixi_4b"
MERGED_DIR = "outputs/baiweixi_4b_merged"
GGUF_FILE = "outputs/baiweixi_4b_q4.gguf"
MODEL = "Qwen/Qwen3-4B"
