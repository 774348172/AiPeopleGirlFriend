...
ADAPTER="adapters/baiweixi"
FUSED="fused_baiweixi"          # 融合后 HF 格式目录
GGUF_DIR="gguf"
...
python llama.cpp/convert_hf_to_gguf.py "$FUSED" \
  --outfile "$GGUF_DIR/baiweixi-f16.gguf" --outtype f16

echo "=== 4/4 量化 Q4_K_M ==="
./llama.cpp/build/bin/llama-quantize \
  "$GGUF_DIR/baiweixi-f16.gguf" "$GGUF_DIR/baiweixi-q4_k_m.gguf" Q4_K_M

echo ""
echo "=== 完成 → $GGUF_DIR/baiweixi-q4_k_m.gguf (~2.3GB) ==="
