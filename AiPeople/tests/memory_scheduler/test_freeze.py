...
from eval.memory_scheduler.freeze import (
    FROZEN_ASSET_PATHS,
...
def test_mem06_frozen_chain_verifies() -> None:
    manifest = verify_manifest()
    assert manifest["scope"]["next_checkpoint"] == "RECALL-01"
    assert manifest["upstream"]["contract_id"] == "mem05-local-bge-vector-projection-v1"
