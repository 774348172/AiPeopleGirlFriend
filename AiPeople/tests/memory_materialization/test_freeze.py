...
from eval.memory_materialization.freeze import (
    MANIFEST_PATH,
...
def test_repository_mem03_manifest_verifies_with_mem02_upstream() -> None:
    assert MANIFEST_PATH.is_file(), "run python -m eval.memory_materialization.freeze --freeze"
    verify_manifest()
