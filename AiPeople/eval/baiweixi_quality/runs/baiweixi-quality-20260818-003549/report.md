...
> Run：`baiweixi-quality-20260818-003549`  
...
| 分类 | 案例 | 通过 | 失败 | 歧义 |
|---|---:|---:|---:|---:|
| `heroine_state_continuity` | 1 | 1 | 0 | 0 |
| `memory_knowledge` | 1 | 1 | 0 | 0 |
| `relationship_pacing` | 1 | 1 | 0 | 0 |
