...
def test_build_package_set_baiweixi_current_p0():
    ...
    assert ps.profile_package_ref == "pkg:profile.baiweixi@0.3.0"
    assert ps.dataset_recipe_ref == "pkg:recipe.baiweixi.v1@0.5.0"
    assert ps.release_policy_ref == "pkg:release.baiweixi.v1@0.3.0"
    assert ps.protocol_bundle_ref == QWX_PACKAGE_SET.protocol_bundle_ref
